...
3. Check **Open Questions** in `development-plan.md` §13 and act on any before starting new work
...
`q_table.json` is regenerated by Q-Learning training and must never be committed — keep it in `.gitignore`.
